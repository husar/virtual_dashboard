 ...
 <div class="portlet box blue">
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                           Nájdeme program "Skicár" a spustíme ho.</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body">
                                        <section class="slide_show">
                                              <div id="home" class="slider">
                                                 <div id="main_slider" class="carousel slide" data-ride="carousel" data-interval="false" data-pause="hover">
                                                    <!-- Indicators -->
                                                        <ol class="carousel-indicators">
                                                          <li data-target="#main_slider" data-slide-to="0" class="active" style=" background:black;"></li>
                                                          <li data-target="#main_slider" data-slide-to="1" style=" background:black;"></li>
                                                          <li data-target="#main_slider" data-slide-to="2" style=" background:black;"></li>
                                                          <li data-target="#main_slider" data-slide-to="3" style=" background:black;"></li>
                                                          <li data-target="#main_slider" data-slide-to="4" style=" background:black;"></li>
                                                          <li data-target="#main_slider" data-slide-to="5" style=" background:black;"></li>
                                                        </ol>
